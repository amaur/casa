        ...
        <section class="container">
            <div class="row add-top-main">
                <article class="span12">
                    <div class="thumb-icon"><img alt="renova" title="renova" src="images/icons/07.png"/></div>
                    <h1 class="main-heading"><span>Erro</span></h1>
                    <h3 class="promo-text"><span>Mensagem não enviada, <a href="contato">tente novamente</a>.</span></h3>
                </article>
            </div>
        </section><!--/ container-->        
    </div><!--/ row-fluid-->   
